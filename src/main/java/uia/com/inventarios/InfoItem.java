...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = SolicitudAjusteNivelInventario.class, name = "SEM")
        })
...
public class InfoItem extends InfoUIA{
    ...
    private int cantidadAjusteNivelInventario = -1;
    ...
    public int getCantidadAjusteNivelInventario() {
        return cantidadAjusteNivelInventario;
    }

    public void setCantidadAjusteNivelInventario(int cantidadAjusteNivelInventario) {
        this.cantidadAjusteNivelInventario = cantidadAjusteNivelInventario;
    }
}
